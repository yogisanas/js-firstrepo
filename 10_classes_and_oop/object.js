...
multipleBy5.power = 2     //--function is also object
...
//--inform chai that creatUser() have additional properties using new keyword
//--new keyword reference is function createUser()
const chai = new createUser("chai", 25)    
const tea = createUser("tea", 250)

// chai.prototype.printMe()   //--no need to write this 
chai.printMe()
